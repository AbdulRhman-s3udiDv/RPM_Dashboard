...
import { getClinics, postClinic, patchClinicHandler, deleteClinicHandler, getClinicBreakdown } from "../controllers/clinics.controller";
...
clinicsRouter.patch("/:id", requireAuth, requireRole("super_admin"), patchClinicHandler);
