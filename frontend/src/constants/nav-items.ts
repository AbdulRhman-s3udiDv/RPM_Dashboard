import {
  LayoutDashboard, Users, Bell, MessageSquare, Receipt, GitBranch,
  Cpu, Truck, Building2, UserCog, BarChart3, Sparkles, Settings,
...
export const navItems: NavItem[] = [
  ...
  { label: 'Device Orders', route: '/devices/orders', icon: Truck },
  ...
  { label: 'Analytics', route: '/analytics', icon: BarChart3, roles: ['super_admin', 'clinic_admin'] },
